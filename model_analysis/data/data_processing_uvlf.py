...
def load_data():
    ...
    madau       = np.load('data/UVLF/Madau2014UVLF.npz')
    madau = {i:madau[j] for i,j in [['0','1'],['1','4'],['2','7'],['3','8'], ['4','9']]}
    duncan      = np.load('data/UVLF/Duncan2014UVLF.npz')      
    bouwens     = np.load('data/UVLF/Bouwens2015UVLF.npz')       
    bouwens2    = np.load('data/UVLF/Bouwens2021UVLF.npz')
    oesch       = np.load('data/UVLF/Oesch2010UVLF.npz')
    parsa       = np.load('data/UVLF/Parsa2016UVLF.npz')
    bhatawdekar = np.load('data/UVLF/Bhatawdekar2019UVLF.npz')
    atek        = np.load('data/UVLF/Atek2018UVLF.npz')
    livermore   = np.load('data/UVLF/Livermore2017UVLF.npz')
    wyder       = np.load('data/UVLF/Wyder2005UVLF.npz')
    arnouts     = np.load('data/UVLF/Arnouts2005UVLF.npz')
    reddy       = np.load('data/UVLF/Reddy2009UVLF.npz')
    oesch2      = np.load('data/UVLF/Oesch2018UVLF.npz')
